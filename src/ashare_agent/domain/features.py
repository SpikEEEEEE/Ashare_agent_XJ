...
from ashare_agent.domain.models import DecisionInput, SymbolMarketSnapshot
...
def build_symbol_context(
    ...
    candidate = decision_input.candidate_metadata.get(snapshot.symbol)
...
def build_decision_context(decision_input: DecisionInput) -> dict[str, Any]:
    return {
        ...
        "market": decision_input.market_id,
        "data_provider": decision_input.data_provider,
        "universe_source": decision_input.universe_source,
        "candidate_pool_id": decision_input.candidate_pool_id,
        "portfolio": {
