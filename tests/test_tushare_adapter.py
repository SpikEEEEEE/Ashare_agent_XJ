...
from ashare_agent.adapters.tushare import LocalMarketCache, TushareMarketDataProvider
from ashare_agent.ports.market_data import DataUnavailableError
...
def test_provider_passes_timeout_to_tushare_constructor(tmp_path, monkeypatch):
    ...
    assert provider._client() is expected_client
