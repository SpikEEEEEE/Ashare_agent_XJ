...
from ashare_agent.repositories.sqlite import SQLiteRepository, TERMINAL_STATUSES
        ...
        worker_environment.update(
            {
                ...
                "ACTIVE_MARKET": self.settings.active_market,
                ...
                "UNIVERSE_SELECTOR": self.settings.universe_selector,
                "SELECTION_DATA_PROVIDER": (
                    self.settings.selection_data_provider
                ),
                "SELECTION_CONFIG_PATH": (
                    str(self.settings.selection_config_path)
                    if self.settings.selection_config_path is not None
                    else ""
                ),
                "SELECTION_DATA_PATH": (
                    str(self.settings.selection_data_path)
                    if self.settings.selection_data_path is not None
                    else ""
                ),
