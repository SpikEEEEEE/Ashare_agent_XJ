...
from .generated_features import (
    ...
    load_feature_availability_date,
...
def build_features(
    ...
    if generated_definitions is None and config.features.generated_feature_path:
        generated_features_available_after = load_feature_availability_date(
    ...
    if universe.exclude_st:
        eligible &= frame["st_status_known"] & ~frame["is_st"]
    ...
    return PreparedData(
        ...
        generated_features_available_after=generated_features_available_after,
    )
