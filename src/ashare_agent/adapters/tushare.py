...
from ashare_agent.domain.models import SymbolMarketSnapshot
from ashare_agent.ports.market_data import (
...
class TushareMarketDataProvider:
    ...
    def _client(self) -> Any:
        ...
        if self._client_instance is None:
            ...
            self._client_instance = ts.pro_api(
                self.settings.tushare_token,
                timeout=self.settings.tushare_timeout_seconds,
            )
